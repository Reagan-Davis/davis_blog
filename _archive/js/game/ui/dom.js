export function getDom() {
  return {
    ...
    achievementsButton: document.getElementById("startupAchievementsButton"),
    achievementsPanel: document.getElementById("startupAchievementsPanel"),
    achievementsCloseBtn: document.getElementById("startupAchievementsClose"),
    achievementsDoorsValue: document.getElementById("startupAchievementDoorsValue"),

    achievementsDoorsFill: document.getElementById("startupAchievementDoorsFill"),
